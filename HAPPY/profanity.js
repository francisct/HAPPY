...
function checkForNegativeNoun(){
    var found = false;
    profanities.forEach(function(profanity){
        if (word.toUpperCase() === profanity.toUpperCase()){
            found = true;
            return;
        }
    });
